...
Source: `results/ratbench_d1_blind_backstop_v2_budgetfix_api_100/llm_attacker_outputs.jsonl`
...
| rbqig_b4 | education institution or credential | exact | 3 |
...
| rbqig_b4 | citizenship phrasing | citizenship_status | Born abroad of American parent(s) | citizen (via American parent) | "my parent is American, so I have citizenship through them"; "verify the expiration date and billing address" (contextual unrelated) |
